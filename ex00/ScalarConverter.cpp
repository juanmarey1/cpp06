...
void    ScalarConverter::printFloat(float num, std::string exception)
{
    if (exception == "nanf" || exception == "+inff" || exception == "-inff")
    {
        std::cout << "char: impossible" << std::endl;
        std::cout << "int: impossible" << std::endl;
        std::cout << "float: " << exception << std::endl;
        std::cout << "double: " << exception.erase(exception.size() - 1) << std::endl;
        return ;
    }
...
void    ScalarConverter::printDouble(double num, std::string exception)
{
    if (exception == "nan" || exception == "+inf" || exception == "-inf")
    {
        std::cout << "char: impossible" << std::endl;
        std::cout << "int: impossible" << std::endl;
        std::cout << "float: " << exception << "f" << std::endl;
